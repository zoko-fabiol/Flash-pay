...
const TransactionDetailsPage: React.FC = () => {
  ...
  const handleGeneratePDF = (recipient?: BulkRecipient) => {
    ...
    try {
      ...
      const mainColor = [102, 20, 137]; // M3 Primary #661489
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          <button onClick={() => navigate('/queue')} className="flex items-center gap-2 text-[#661489] font-black uppercase text-[10px] tracking-widest mb-4 hover:translate-x-[-4px] transition-transform">
      ...
      {transaction.status === 'completed' && (
        <div className="m3-card-elevated flex flex-col items-center justify-center py-16 text-center animate-in zoom-in duration-700 border-b-4 border-[#661489]">
          <div className="w-24 h-24 bg-[#661489] text-white rounded-full flex items-center justify-center mb-8 shadow-2xl shadow-[#661489]/40 scale-110">
            <Check size={48} strokeWidth={4} />
          </div>
          <h2 className="text-2xl font-black text-[#661489] tracking-tight uppercase mb-2">Transfert effectué</h2>
          ...
          <div className="flex items-center gap-4 mt-12">
            <button 
              ...
              className={`px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm transition-all ${
                activeTab === 'update' ? 'bg-[#661489] text-white' : 'bg-[#F3EDF7] text-[#661489] hover:bg-[#EADDFF]'
              }`}
            >
              Mise à jour
            </button>
            <button 
              ...
              className={`px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm transition-all ${
                activeTab === 'details' ? 'bg-[#661489] text-white' : 'bg-white border border-[#E7E0EB] text-[#49454F] hover:bg-[#F3EDF7]'
              }`}
            >
              Détails
            </button>
        ...
        {activeTab === 'details' ? (
          <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="m3-card flex flex-col justify-between">
                ...
                <div>
                  ...
                  <div className="flex flex-col mt-1">
                    {transaction.clientPhone && <a href={`tel:${transaction.clientPhone}`} className="text-[#661489] text-[10px] font-bold hover:underline">{transaction.clientPhone}</a>}
              ...
              <div className="m3-card flex flex-col justify-between">
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-[#F3EDF7] text-[#661489] rounded-[16px]"><CreditCard size={24} /></div>
                  <div className="text-[9px] font-black uppercase tracking-widest text-[#661489] bg-[#EADDFF] px-2 py-0.5 rounded-md">{transaction.currency}</div>
                </div>
                <div>
              ...
              <div className="m3-card bg-[#EADDFF] border-transparent flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-white text-[#661489] rounded-[16px] shadow-sm">
                ...
                <div>
                  <p className="text-[#661489] text-[9px] font-black uppercase tracking-widest mb-1">
            ...
            {transaction.isBulk ? (
              <div className="m3-card-elevated !p-0 overflow-hidden">
                <div className="p-8 border-b border-[#E7E0EB] flex justify-between items-center bg-[#F3EDF7]/30">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-[#661489] text-white rounded-[16px] flex items-center justify-center shadow-lg"><Smartphone size={24} /></div>
                    <div>
                        ...
                        <tr key={recipient.id} className="hover:bg-[#F3EDF7]/30 transition-all group">
                          <td className="px-8 py-6">
                            ...
                            <div className="mt-1 flex flex-col">
                                {recipient.phone && <a href={`tel:${recipient.phone}`} className="text-[10px] font-bold text-[#661489] hover:underline">{recipient.phone}</a>}
                          ...
                          <td className="px-8 py-6 text-right">
                            <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                              {recipient.status !== 'completed' && (
                                <button onClick={() => handleUpdateBulkRecipientStatus(recipient.id, 'completed')} className="p-2 bg-[#E8DEF8] text-[#661489] rounded-lg hover:shadow-md"><CheckCircle2 size={16} /></button>
                              )}
              ...
              <div className="m3-card-elevated">
                <div className="flex justify-between items-start mb-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-[#F3EDF7] text-[#661489] rounded-[16px] flex items-center justify-center"><Smartphone size={24} /></div>
                    <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#F3EDF7] p-5 rounded-[24px]">
                      ...
                      <p className="text-[#661489] font-black text-lg tracking-tight uppercase">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#EADDFF] p-5 rounded-[24px]">
                      <p className="text-[#661489] text-[9px] font-black uppercase tracking-widest mb-1">Net à Percevoir</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in slide-in-from-left-4 duration-500">
              ...
              <div className="m3-card-elevated">
                <div className="flex justify-between items-center mb-8">
                  <h3 className="text-xl font-black text-[#1D1B20] tracking-tight flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#F3EDF7] text-[#661489] rounded-[12px] flex items-center justify-center"><FileText size={20} /></div>
                    Preuve de Règlement
                  </h3>
                </div>
                ...
                {transaction.proofUrl && transaction.proofUrl !== 'PAID_WITH_BONUS' ? (
                  <div className="relative group rounded-[32px] overflow-hidden border border-[#E7E0EB] bg-[#F3EDF7] shadow-inner">
                    ...
                    <div className="absolute inset-0 bg-[#1D1B20]/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <button onClick={() => openProof(transaction.proofUrl)} className="p-5 bg-white rounded-full shadow-2xl text-[#661489] hover:scale-110 transition-transform">
                        <ExternalLink size={28} />
                      </button>
                    </div>
                  </div>
                ) : transaction.proofUrl === 'PAID_WITH_BONUS' ? (
                  <div className="p-20 text-center bg-[#EADDFF]/30 rounded-[32px] border-2 border-dashed border-[#661489]/20">
                    <Award size={48} className="mx-auto text-[#661489] mb-4 animate-bounce" />
                    <p className="text-[#661489] font-black uppercase text-[12px] tracking-[0.1em] mb-2">Payé par Bonus</p>
                  </div>
                ) : (
                  <div className="p-20 text-center bg-[#F3EDF7] rounded-[32px] border-2 border-dashed border-[#E7E0EB]">
                    <AlertCircle size={48} className="mx-auto text-[#661489]/20 mb-4" />
            ...
            <div className="space-y-8">
              {/* Main Action Card */}
              <div className="bg-[#661489] p-8 rounded-[32px] shadow-2xl shadow-[#661489]/30 text-white space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <button 
                    ...
                    className="w-full py-4 bg-white text-[#661489] font-black uppercase text-[10px] tracking-widest rounded-full hover:shadow-2xl transition-all disabled:opacity-50"
                  >
              ...
              <div className="m3-card-elevated space-y-8 !p-8">
                <h3 className="text-sm font-black text-[#1D1B20] uppercase tracking-widest flex items-center gap-3">
                  <Clock size={20} className="text-[#661489]" /> Chronologie
                </h3>
                  ...
                  {transaction.statusHistory?.slice().reverse().map((entry, i) => (
                    <div key={i} className="relative pl-12">
                      <div className={`absolute left-0 top-0 w-6 h-6 rounded-full flex items-center justify-center z-10 ${
                        i === 0 ? 'bg-[#661489] text-white shadow-lg shadow-[#661489]/20' : 'bg-[#EADDFF] text-[#661489]'
                      }`}>
