  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-2xl bg-[#7E509D]/10 flex items-center justify-center text-[#7E509D]">
      ...
      <div className="bg-white rounded-[32px] p-8 shadow-[0_20px_50px_rgba(126,80,157,0.05)] border border-slate-100">
        <div className="flex items-center gap-3 mb-8 pb-4 border-b border-slate-50">
          <div className="w-10 h-10 rounded-xl bg-[#7E509D]/5 flex items-center justify-center text-[#7E509D]">
            <Plus size={20} />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 gap-8">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full px-6 py-4 bg-slate-50 border-2 border-transparent rounded-[20px] focus:border-[#7E509D] focus:bg-white focus:ring-4 focus:ring-[#7E509D]/5 outline-none transition-all text-slate-900 font-bold placeholder:text-slate-400 placeholder:font-medium"
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full px-6 py-5 bg-slate-50 border-2 border-transparent rounded-[24px] focus:border-[#7E509D] focus:bg-white focus:ring-4 focus:ring-[#7E509D]/5 outline-none transition-all text-slate-900 font-bold resize-none min-h-[180px] placeholder:text-slate-400 placeholder:font-medium"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div 
              ...
              className={`p-6 rounded-[24px] border-2 cursor-pointer transition-all flex items-center gap-5 group ${sendEmail ? 'border-[#7E509D] bg-[#7E509D]/5' : 'border-slate-100 hover:border-slate-300 bg-white'}`}
            >
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${sendEmail ? 'bg-[#7E509D] text-white shadow-lg shadow-[#7E509D]/20' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200'}`}>
                <Mail size={24} />
              </div>
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span className={`font-black text-base ${sendEmail ? 'text-slate-900' : 'text-slate-500'}`}>Par Email</span>
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${sendEmail ? 'border-[#7E509D] bg-[#7E509D] text-white' : 'border-slate-200'}`}>
            ...
            <div 
              ...
              className={`p-6 rounded-[24px] border-2 cursor-pointer transition-all flex items-center gap-5 group ${sendNotification ? 'border-[#7E509D] bg-[#7E509D]/5' : 'border-slate-100 hover:border-slate-300 bg-white'}`}
            >
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all ${sendNotification ? 'bg-[#7E509D] text-white shadow-lg shadow-[#7E509D]/20' : 'bg-slate-100 text-slate-400 group-hover:bg-slate-200'}`}>
                <Bell size={24} />
              </div>
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <span className={`font-black text-base ${sendNotification ? 'text-slate-900' : 'text-slate-500'}`}>En Notification</span>
                  <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${sendNotification ? 'border-[#7E509D] bg-[#7E509D] text-white' : 'border-slate-200'}`}>
      ...
      <div className="bg-white rounded-[32px] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-100">
        ...
        {loadingBroadcasts ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
             <div className="w-10 h-10 border-4 border-slate-100 border-t-[#7E509D] rounded-full animate-spin" />
          ...
          <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
            {broadcasts.map((broadcast) => (
              <div key={broadcast.id} className="p-6 bg-white border border-slate-100 rounded-[24px] hover:border-[#7E509D]/30 hover:shadow-lg transition-all group relative overflow-hidden">
                <div className="flex justify-between items-start relative z-10">
                  <div className="flex-1 min-w-0 pr-12">
                    ...
                    <div className="flex gap-6 mt-6 text-[10px] font-black uppercase tracking-widest text-slate-400">
                      ...
                      {broadcast.sendEmail && (
                        <div className="flex items-center gap-2 text-[#7E509D]">
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#7E509D]/5 rounded-full -mr-16 -mt-16 group-hover:bg-[#7E509D]/10 transition-all"></div>
              </div>
            ))}
          </div>
        )}
