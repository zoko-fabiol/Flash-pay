    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4 text-[#49454F]">
          <div className="w-12 h-12 border-4 border-[#470B37] border-t-transparent rounded-full animate-spin" />
    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <div className="m3-card-elevated !bg-gradient-to-br !from-[#EADDFF] !to-[#F3EDF7] border border-[#CAC4D0]/30 space-y-6">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-2xl bg-white text-[#470B37] shadow-lg">
            <UserPlus size={22} />
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full py-3.5 bg-[#470B37] text-white rounded-[20px] font-black uppercase text-[10px] tracking-widest shadow-lg hover:scale-[1.02] transition-all disabled:opacity-50"
            >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        <div className="m3-card-elevated space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {(['super', 'restricted', 'email-only'] as const).map((role) => (
                <button
                  ...
                  className={`rounded-[22px] border px-4 py-4 text-left transition-all ${selectedRole === role ? 'bg-[#470B37] text-white border-[#470B37]' : 'bg-white border-[#E7E0EB] text-[#1D1B20]'}`}
                >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {ADMIN_SECTION_DEFINITIONS.map((section) => {
                ...
                return (
                  <label key={section.key} className="flex items-center justify-between gap-3 rounded-[20px] border border-[#E7E0EB] px-4 py-3 bg-white hover:bg-[#F3EDF7] hover:border-[#470B37]/30 transition-all cursor-pointer group">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {(['add', 'edit', 'delete'] as const).map((action) => {
                ...
                return (
                  <label key={action} className="flex items-center justify-between gap-3 rounded-[20px] border border-[#E7E0EB] px-4 py-3 bg-[#F3EDF7] hover:bg-[#EADDFF] hover:border-[#470B37]/30 transition-all cursor-pointer group">
          ...
          <label className="flex items-center justify-between gap-4 rounded-[24px] border border-[#E7E0EB] px-5 py-4 bg-[#EADDFF]/40 hover:bg-[#EADDFF]/60 hover:border-[#470B37]/30 transition-all cursor-pointer group">
            <div>
          ...
          <button
            ...
            className="w-full py-4 bg-[#470B37] text-white rounded-[28px] font-black uppercase text-[11px] tracking-widest shadow-2xl hover:scale-[1.01] transition-all disabled:opacity-50"
          >
        ...
        <div className="m3-card-elevated space-y-8">
          ...
          <div className="flex gap-3">
            ...
            />
            <button onClick={addEmail} className="p-4 bg-[#470B37] text-white rounded-full shadow-lg hover:scale-110 transition-transform">
              <Plus size={18} />
            </button>
          </div>
            ...
            {notificationEmails.length === 0 ? (
              ...
              notificationEmails.map((email) => (
                <div key={email} className="flex items-center justify-between rounded-[22px] border border-[#E7E0EB] px-4 py-3 bg-white">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-full bg-[#F3EDF7] text-[#470B37]">
          ...
          <div className="rounded-[28px] bg-[#F3EDF7] border border-[#E7E0EB] p-6 space-y-4">
            <div className="flex items-center gap-3">
              <SlidersHorizontal className="text-[#470B37]" size={20} />
