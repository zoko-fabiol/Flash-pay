...
const COLORS = ['#6344B6', '#9B89C9', '#EADDFF', '#21005D', '#49454F', '#79747E'];
...
const AnalyticsPage: React.FC = () => {
  ...
  const generatePDF = () => {
    ...
    try {
      ...
      // Header
      pdf.setFillColor(103, 80, 164); // #6344B6
  ...
  return (
    <div className="space-y-10 pb-20 animate-in fade-in duration-700">
        ...
        <div className="flex items-center gap-3 bg-[#F3EDF7] p-1.5 rounded-[24px] border border-[#E7E0EB] shadow-sm">
           {[
             ...
             <button 
              ...
              className={`px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${timeRange === range.id ? 'bg-[#6344B6] text-white shadow-md' : 'text-[#49454F] hover:bg-white'}`}
             >
               {range.label}
             </button>
           ))}
      ...
      <div className="bg-gradient-to-r from-[#6344B6] to-[#21005D] rounded-[32px] p-8 text-white shadow-xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
         ...
         <div className="m3-card-elevated group">
            <div className="flex justify-between items-start mb-4">
               <div className="p-3 bg-[#F3EDF7] text-[#6344B6] rounded-2xl group-hover:scale-110 transition-transform shadow-sm"><Activity size={20} /></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <AreaChart data={stats.chartData}>
                  <defs>
                    <linearGradient id="colorRub" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#6344B6" stopOpacity={0.3}/>
                  ...
                  <Area name="Volume RUB" type="monotone" dataKey="rub" stroke="#6344B6" strokeWidth={4} fillOpacity={1} fill="url(#colorRub)" animationDuration={2000} />
                </AreaChart>
              </ResponsiveContainer>
           </div>
        </div>
        ...
        <div className="m3-card-elevated !p-8">
           <div className="flex items-center gap-3 mb-10">
              <div className="p-2 bg-[#F3EDF7] text-[#6344B6] rounded-lg shadow-sm"><Activity size={18} /></div>
           ...
           <div className="space-y-4 mt-6">
              {stats.operatorData.map((op, i) => (
                <div key={op.name} className="flex items-center justify-between">
                   ...
                   <span className="text-[11px] font-black text-[#6344B6]">{op.value} tx</span>
                </div>
              ))}
           </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="h-[350px]">
               <ResponsiveContainer width="100%" height="100%">
                 <BarChart data={stats.countryData} layout="vertical" margin={{ left: 20 }}>
                   ...
                   />
                   <Bar dataKey="value" fill="#6344B6" radius={[0, 10, 10, 0]} barSize={20} animationDuration={1500} />
                 </BarChart>
               </ResponsiveContainer>
            </div>
         </div>
         ...
         <div className="m3-card-elevated !p-8 bg-gradient-to-br from-[#6344B6] to-[#21005D] text-white">
            ...
            <div className="mt-12 pt-12 border-t border-white/10">
               <button onClick={generatePDF} className="w-full py-4 bg-white text-[#6344B6] rounded-full font-black uppercase text-[10px] tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all">Générer Rapport PDF</button>
            </div>
         </div>
      </div>
    </div>
