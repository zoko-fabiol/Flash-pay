    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          <h2 className="text-3xl font-black text-[#1D1B20] tracking-tight flex items-center gap-4">
            <div className="w-12 h-12 bg-[#6344B6] text-white rounded-[16px] flex items-center justify-center shadow-lg"><Award size={24} /></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="m3-card-elevated bg-[#F3EDF7]/50 flex items-center gap-5 border-[#E7E0EB]">
           <div className="w-14 h-14 bg-white text-[#6344B6] rounded-2xl flex items-center justify-center shadow-sm"><Gift size={28} /></div>
           <div>
        ...
        <div className="m3-card-elevated bg-[#6344B6] text-white flex items-center gap-5 shadow-xl shadow-[#6344B6]/20">
                  ...
                  <tr key={partner.id} className="hover:bg-[#F3EDF7]/30 transition-all group">
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-[#EADDFF] text-[#21005D] rounded-[18px] flex items-center justify-center font-black text-lg border border-[#6344B6]/10 shadow-sm group-hover:scale-110 transition-transform">
                    ...
                    <td className="px-8 py-6">
                       <div className="flex flex-col gap-2">
                          <span className="inline-flex items-center bg-[#F3EDF7] text-[#6344B6] px-3 py-1 rounded-full text-[10px] font-mono font-black tracking-widest border border-[#E7E0EB] shadow-sm w-fit">
