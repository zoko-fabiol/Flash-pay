    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          {currentLabel && (
            <div className="px-4 py-2 rounded-full bg-[#6344B6]/40 backdrop-blur-md border border-[#6344B6]/40">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            download
            className="p-2.5 rounded-2xl bg-[#6344B6]/50 hover:bg-[#6344B6] border border-[#6344B6]/50 text-white transition-all"
            title="Télécharger"
            onClick={(e) => e.stopPropagation()}
          >
            <Download size={16} />
      ...
      {hasPrev && (
        <button
          ...
          className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-4 rounded-full bg-white/10 hover:bg-[#6344B6]/60 backdrop-blur-md border border-white/20 text-white transition-all hover:scale-110 shadow-2xl"
      ...
      {hasNext && (
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-4 rounded-full bg-white/10 hover:bg-[#6344B6]/60 backdrop-blur-md border border-white/20 text-white transition-all hover:scale-110 shadow-2xl"
          aria-label="Suivant"
        >
          ...
          {images.map((src, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: 16,
                border: i === index ? '2px solid #6344B6' : '2px solid rgba(255,255,255,0.15)',
