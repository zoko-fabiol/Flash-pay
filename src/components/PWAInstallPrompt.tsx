...
const APK_URL = 'https://github.com/zoko-fabiol/Flash-pay/releases/latest/download/FlashPay.apk'; // Remplacez par votre lien réel
...
export const PWAInstallPrompt: React.FC = () => {
  ...
  const handleInstallClick = () => {
    if (isAndroid) {
      // Pour Android, on télécharge l'APK
