...
export const TransactionDetailPage: React.FC = () => {
  ...
  const handleReceiptDownload = async (recipient?: any) => {
    ...
    try {
      ...
      const mainColor = [102, 20, 137]; // #470B37
    ...
    return (
      <Layout>
        <div className="mx-auto max-w-xl rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <button onClick={() => navigate('/transactions')} className="mt-4 inline-flex items-center gap-2 rounded-full bg-[#470B37] px-5 py-3 font-semibold text-white">
      ...
      <div className="mx-auto max-w-md space-y-5 pb-24 pt-2 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex items-center justify-between px-1">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full text-[#470B37] hover:bg-[#470B37]/10 transition-all"
            aria-label="Retour"
          >
            <ArrowLeft size={22} />
          </button>
        ...
        <div className="overflow-hidden rounded-[32px] border border-[#eadfff] bg-white shadow-[0_20px_60px_rgba(98,54,204,0.10)]">
          <div className="bg-white px-6 pt-10 pb-8 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#EFE7FF] text-[#470B37] shadow-sm">
                {currentStatus === 'completed' ? <CheckCircle2 size={28} /> : <Send size={28} />}
              </div>

              <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-[0.35em] text-[#470B37]">
          ...
          <div className="space-y-6 bg-[#FCFAFF] px-5 pb-6 pt-4 min-h-[400px]">
            {activeTab === 'update' ? (
              <>
            {transaction.isBulk && (
              <div className="rounded-[28px] border border-[#470B37]/10 bg-white p-6 space-y-5 shadow-[0_10px_30px_rgba(98,54,204,0.06)]">
                <div className="flex justify-between items-end">
                  <div className="space-y-1">
                    <h3 className="text-[#470B37] font-black text-lg tracking-tight">Progression de l'envoi</h3>
                  ...
                  <div className="text-right">
                    <span className="text-3xl font-black text-[#470B37] tracking-tighter">{Math.round(bulkProgress)}%</span>
                  </div>
                </div>
                <div className="w-full h-4 bg-[#F3EDF7] rounded-full overflow-hidden p-1 shadow-inner">
                  <div
                    className="h-full bg-gradient-to-r from-[#7C4DFF] to-[#470B37] rounded-full transition-all duration-1000 ease-out shadow-lg"
            ...
            <div className="space-y-4">
              <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] flex items-center gap-3 px-2">
                <div className="w-1 h-4 bg-[#470B37] rounded-full"></div>
                ...
                <div className="rounded-[28px] border border-[#eadfff] bg-white p-6 shadow-[0_10px_30px_rgba(98,54,204,0.06)]">
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm font-black text-[#470B37] tracking-tight">{transaction.currency}</p>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        {rec.status === 'completed' && (
                          <button
                            ...
                            className="p-4 bg-[#470B37]/5 text-[#470B37] rounded-[20px] hover:bg-[#470B37] hover:text-white transition-all shadow-sm border border-[#470B37]/10"
            ...
            {!transaction.isBulk && (
              <div className="rounded-[28px] border border-[#eadfff] bg-white p-6 shadow-[0_10px_30px_rgba(98,54,204,0.06)]">
                <div className="flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.28em] text-[#470B37] mb-8">
                  <div className="p-2 bg-[#470B37]/10 rounded-lg">
                    <Clock3 size={18} />
                  </div>
                  Mise à jour
                </div>
                    ...
                    return (
                      <div key={status} className="flex gap-6 relative z-10 group">
                        <div className={`flex h-8 w-8 items-center justify-center rounded-full transition-all duration-700 ${
                          ...
                          active ? 'bg-[#470B37] text-white shadow-xl shadow-[#470B37]/30 scale-110' : 'bg-white border-2 border-[#f3edff] text-[#f3edff]'
                        }`}>
            ...
            {currentStatus === 'completed' && !transaction.isBulk && (
              <div className="rounded-[28px] border border-[#eadfff] bg-gradient-to-br from-white to-[#F3EDF7]/50 p-6 shadow-[0_18px_50px_rgba(98,54,204,0.10)]">
                <div className="flex items-start gap-4">
                  <div className="w-16 h-16 bg-white rounded-3xl flex items-center justify-center text-[#470B37] shadow-lg border border-[#eadfff]">
                    <FileText size={30} />
                  </div>
                  <div className="flex-1 space-y-1">
                ...
                <button
                  ...
                  className="mt-6 w-full px-6 py-4 bg-[#470B37] text-white font-black rounded-full shadow-[0_14px_30px_rgba(98,54,204,0.24)] active:scale-95 transition-all flex items-center justify-center gap-4"
                >
