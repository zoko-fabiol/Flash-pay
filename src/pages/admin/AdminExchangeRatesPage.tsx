      ...
      <div className="max-w-4xl mx-auto py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 bg-[#470B37] text-white px-6 py-3 rounded-full font-black shadow-lg hover:scale-105 transition-all disabled:opacity-50"
          >
            <Save size={20} />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-4 rounded-2xl border-2 border-slate-100 focus:border-[#470B37] outline-none font-bold"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-4 rounded-2xl border-2 border-slate-100 focus:border-[#470B37] outline-none font-bold pr-12"
                  />
